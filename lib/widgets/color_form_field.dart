...
class ColorFormField extends StatefulWidget {
  ...
  ColorFormField({Key key, this.onChanged, @required this.intialColor})
      : super(key: key) {
...
class _ColorFormFieldState extends State<ColorFormField> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
        onTap: () {
          getColor(context: context, intialColor: widget.intialColor)
              .then((value) {
  ...
  static Future<Color> getColor(
      {@required BuildContext context, @required Color intialColor}) async {
